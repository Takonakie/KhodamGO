...
class HasilActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val khodamList = listOf(
            ...
            KhodamModel("Khodam H","Garuda","Garuda melambangkan kekuatan, kebijaksanaan, dan kehormatan. Sebagai khodam yang mengendalikan angin dan energi alam, Garuda memiliki visi besar dan kemampuan untuk memahami dan mengarahkan kekuatan alam dengan wawasan intuitif","Garuda memiliki kekuatan untuk mengendalikan angin,dan juga memanipulasi energi alam,selain itu garuda juga memiliki kekuatan fisik yang sangat kuat, seseorang akan sangat beruntung jika dia memiliki khodam ini",R.drawable.raja_ayam_img),
            ...
            KhodamModel("Khodam J","Dewi Api","Dewi Api adalah khodam yang mengendalikan api dengan kecerdasan dan ketenangan. Ia tidak terburu-buru dalam tindakannya, melainkan lebih banyak merenung dan merencanakan dengan cermat sebelum menggunakan kekuatannya. ","Sesuai dengan namanya Dewi Api memiliki kekuatan untuk mengendalikan Api, bahkan api yang dia kendalikan bisa sampai ke tahap Api Hitam yang paling panas",R.drawable.dewi_api_img),
