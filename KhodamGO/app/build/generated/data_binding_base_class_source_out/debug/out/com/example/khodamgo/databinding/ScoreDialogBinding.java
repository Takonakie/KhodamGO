...
public final class ScoreDialogBinding implements ViewBinding {
  ...
  private ScoreDialogBinding(@NonNull LinearLayout rootView, @NonNull ImageView characterImageView,
      @NonNull Button finishBtn, @NonNull TextView scoreSubtitle, @NonNull TextView scoreTitle) {
  ...
  public static ScoreDialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ScoreDialogBinding((LinearLayout) rootView, characterImageView, finishBtn,
          scoreSubtitle, scoreTitle);
    }
